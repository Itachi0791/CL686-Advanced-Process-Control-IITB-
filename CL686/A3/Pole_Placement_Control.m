function [X,U,SSE,SSMV] = Pole_Placement_Control()
    %clc; clear; close all;
    ...
    p_des = [0.9382;0.9567;0.8458;0.8751]; % Desired Closed loop poles
    G = place(Phi,Gamma_u,p_des);
...
% 
% fprintf('\n\n  Metrics for the Pole Placement Controller:\n');
% fprintf('-------------------------------------------\n');
% fprintf('%-25s %-20s\n', 'Metric', 'Value');
% fprintf('-------------------------------------------\n');
% 
...
% sgtitle("Pole Placement Controller - Controlled States", "FontSize", 25, "FontWeight", "bold");
% 
% for i = 1:4
%     subplot(2,2,i)
%     hold on
...
% figure;
% set(gcf, 'WindowState', 'maximized'); 
% sgtitle("Pole Placement Controller - Manipulated Inputs", "FontSize", 25, "FontWeight", "bold");
% 
% for i = 1:2
%     subplot(2,1,i)
%     hold on
